...
public class UniversityApplicantService implements ApplicantService {
	...
	public List<ApplicantDTO> getAllApplicants() {
		String log = "ALL APPLICANTS FETCHED :-> ";
	...
	public ApplicantDTO createApplicant(CreateApplicantDTO createApplicantDTO) throws BadRequestException {
		...
		if (createApplicantDTO.getName() == null || createApplicantDTO.getDateOfBirth() == null
				|| createApplicantDTO.getEmail() == null || createApplicantDTO.getAddress() == null) {
	...
	public ApplicantDTO updateApplicant(Long applicantId, UpdateApplicantDTO updateApplicantDTO)
			throws BadRequestException {
		if (applicantId == null || (updateApplicantDTO.getAddress() == null && updateApplicantDTO.getEmail() == null
				&& updateApplicantDTO.getName() == null && updateApplicantDTO.getDateOfBirth() == null)) {
			StringBuilder message = new StringBuilder("BAD REQUEST :-> ");
			if (applicantId == null) {
				message.append("APPLICANT ID NOT FOUND ");
			}
			if (updateApplicantDTO.getAddress() == null && updateApplicantDTO.getEmail() == null
					&& updateApplicantDTO.getName() == null && updateApplicantDTO.getDateOfBirth() == null) {
				message.append(
						"INSUFFICIENT INFORMATION TO UPDATE THE APPLICANT DETAILS. AT LEAST ADD ONE FIELD TO UPDATE.");
			}
	...
	public ApplicantDTO updateApplicantStatus(Long applicantID,
			UpdateApplicantAdmissionStatusDTO updateApplicantAdmissionStatusDTO)
