...
public class UniversityDepartmentService implements DepartmentService {
	...
	public List<DepartmentDTO> getAllDepartments() {
		String log = "ALL DEPARTMENTS FETCHED :-> ";
	...
	public DepartmentDTO deleteDepartment(Long departmentID) throws BadRequestException, NoDepartmentFoundException {
		...
		log.append("DEPARTMENT DELETED :-> ").append(departmentDTO.getName());
		if (departmentDTO == null) {
			log.append("NO SUCH DEPARTMENT WITH WITH GIVEN ID ").append(departmentID);
			AdmissionLogger.logError(log.toString());
